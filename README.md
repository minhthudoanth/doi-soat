...
* **Đường link Public toàn cầu (mở từ bất kỳ máy tính, laptop, điện thoại nào):**
  👉 **`https://shaped-fcc-cage-human.trycloudflare.com`**
  *(Chạy qua Cloudflare Tunnel bảo mật HTTPS, cập nhật realtime 100% từ cụm StarRocks VPN)*
* **Đường link nội bộ trên máy này:** [http://127.0.0.1:5000](http://127.0.0.1:5000) hoặc [http://localhost:5000](http://localhost:5000)
* **Tên miền cục bộ:** [http://doi-soat.local:5000](http://doi-soat.local:5000)
